...
#ifndef RTW_HEADER_M1PosHP0_h_
#define RTW_HEADER_M1PosHP0_h_
#include <string.h>
#include <stddef.h>
#ifndef M1PosHP0_COMMON_INCLUDES_
# define M1PosHP0_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* M1PosHP0_COMMON_INCLUDES_ */

#include "M1PosHP0_types.h"
...
struct tag_RTM_M1PosHP0_T {
  const char_T * volatile errorStatus;
};

/* Block states (default storage) */
extern DW_M1PosHP0_T M1PosHP0_DW;

/* External inputs (root inport signals with default storage) */
extern ExtU_M1PosHP0_T M1PosHP0_U;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_M1PosHP0_T M1PosHP0_Y;

/* Constant parameters (default storage) */
extern const ConstP_M1PosHP0_T M1PosHP0_ConstP;

/* Model entry point functions */
extern void M1PosHP0_initialize(void);
extern void M1PosHP0_step(void);
extern void M1PosHP0_terminate(void);

/* Real-time Model object */
extern RT_MODEL_M1PosHP0_T *const M1PosHP0_M;
 ...
 *
 * hilite_system('M1PosHP/M1PosHP')    - opens subsystem M1PosHP/M1PosHP
 * hilite_system('M1PosHP/M1PosHP/Kp') - opens and selects block Kp
 *
