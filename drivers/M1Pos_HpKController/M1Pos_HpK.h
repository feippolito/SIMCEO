...
#ifndef RTW_HEADER_M1Pos_HpK_h_
#define RTW_HEADER_M1Pos_HpK_h_
#include <string.h>
#include <stddef.h>
#ifndef M1Pos_HpK_COMMON_INCLUDES_
# define M1Pos_HpK_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* M1Pos_HpK_COMMON_INCLUDES_ */

#include "M1Pos_HpK_types.h"
...
struct tag_RTM_M1Pos_HpK_T {
  const char_T * volatile errorStatus;
};

/* Block states (default storage) */
extern DW_M1Pos_HpK_T M1Pos_HpK_DW;

/* External inputs (root inport signals with default storage) */
extern ExtU_M1Pos_HpK_T M1Pos_HpK_U;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_M1Pos_HpK_T M1Pos_HpK_Y;

/* Constant parameters (default storage) */
extern const ConstP_M1Pos_HpK_T M1Pos_HpK_ConstP;

/* Model entry point functions */
extern void M1Pos_HpK_initialize(void);
extern void M1Pos_HpK_step(void);
extern void M1Pos_HpK_terminate(void);

/* Real-time Model object */
extern RT_MODEL_M1Pos_HpK_T *const M1Pos_HpK_M;
 ...
 *
 * hilite_system('M1Pos/M1Pos_HpK')    - opens subsystem M1Pos/M1Pos_HpK
 * hilite_system('M1Pos/M1Pos_HpK/Kp') - opens and selects block Kp
 *
