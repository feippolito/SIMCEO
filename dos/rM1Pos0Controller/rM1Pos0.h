...
#ifndef RTW_HEADER_rM1Pos0_h_
#define RTW_HEADER_rM1Pos0_h_
#include <string.h>
#include <stddef.h>
#ifndef rM1Pos0_COMMON_INCLUDES_
# define rM1Pos0_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* rM1Pos0_COMMON_INCLUDES_ */

#include "rM1Pos0_types.h"
...
struct tag_RTM_rM1Pos0_T {
  const char_T * volatile errorStatus;
};

/* Block states (default storage) */
extern DW_rM1Pos0_T rM1Pos0_DW;

/* External inputs (root inport signals with default storage) */
extern ExtU_rM1Pos0_T rM1Pos0_U;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_rM1Pos0_T rM1Pos0_Y;

/* Constant parameters (default storage) */
extern const ConstP_rM1Pos0_T rM1Pos0_ConstP;

/* Model entry point functions */
extern void rM1Pos0_initialize(void);
extern void rM1Pos0_step(void);
extern void rM1Pos0_terminate(void);

/* Real-time Model object */
extern RT_MODEL_rM1Pos0_T *const rM1Pos0_M;
 ...
 *
 * hilite_system('rM1Pos/rM1Pos')    - opens subsystem rM1Pos/rM1Pos
 * hilite_system('rM1Pos/rM1Pos/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'rM1Pos'
 * '<S1>'   : 'rM1Pos/rM1Pos'
 * '<S2>'   : 'rM1Pos/rM1Pos/Reorder'
 */
#endif                                 /* RTW_HEADER_rM1Pos0_h_ */
