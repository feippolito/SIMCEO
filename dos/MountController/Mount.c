...
void Mount_step(void)
{
  ...
  /* Update for DiscreteStateSpace: '<S8>/Discrete State-Space' */
  {
    ...
    xnew[0] += (-0.7377983434649209)*rtb_Sum4;
    ...
    xnew[1] += (46.02193696622767)*rtb_Sum4;
    ...
    xnew[2] += (0.48459507542632629)*rtb_Sum4;
    ...
    xnew[3] += (2.5517673496413527)*rtb_Sum4;
    ...
    xnew[4] += (1.5229386806603502)*rtb_Sum4;
    ...
    xnew[5] += (0.09193664582689591)*rtb_Sum4;
    ...
    xnew[6] += (-7.3768486429063573)*rtb_Sum4;
    ...
    xnew[7] += (-1.8652527444758054)*rtb_Sum4;
    ...
    xnew[8] += (-6.5726227642994335)*rtb_Sum4;
  ...
  /* Update for DiscreteStateSpace: '<S4>/Discrete State-Space' */
  {
    ...
    xnew[0] += (-2.12485922917896)*rtb_Sum1;
    ...
    xnew[1] += (-58.71181175445048)*rtb_Sum1;
    ...
    xnew[2] += (-1.2635650052726954)*rtb_Sum1;
    ...
    xnew[3] += (52.928130096701445)*rtb_Sum1;
    ...
    xnew[4] += (0.85585943876559267)*rtb_Sum1;
    ...
    xnew[5] += (16.455144489927044)*rtb_Sum1;
    ...
    xnew[6] += (0.27753655847229508)*rtb_Sum1;
    ...
    xnew[7] += (-1.7623497268783332)*rtb_Sum1;
    ...
    xnew[8] += (-4.3038144485957064)*rtb_Sum1;
