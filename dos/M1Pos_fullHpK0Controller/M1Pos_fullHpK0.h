...
#ifndef RTW_HEADER_M1Pos_fullHpK0_h_
#define RTW_HEADER_M1Pos_fullHpK0_h_
#include <string.h>
#include <stddef.h>
#ifndef M1Pos_fullHpK0_COMMON_INCLUDES_
# define M1Pos_fullHpK0_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* M1Pos_fullHpK0_COMMON_INCLUDES_ */

#include "M1Pos_fullHpK0_types.h"
...
} ConstP_M1Pos_fullHpK0_T;

/* External inputs (root inport signals with default storage) */
typedef struct {
  real_T Feedback[42];                 /* '<Root>/Feedback' */
} ExtU_M1Pos_fullHpK0_T;

/* External outputs (root outports fed by signals with default storage) */
typedef struct {
  real_T Output[42];                   /* '<Root>/Output' */
} ExtY_M1Pos_fullHpK0_T;

/* Real-time Model Data Structure */
struct tag_RTM_M1Pos_fullHpK0_T {
  const char_T * volatile errorStatus;
};

/* Block states (default storage) */
extern DW_M1Pos_fullHpK0_T M1Pos_fullHpK0_DW;

/* External inputs (root inport signals with default storage) */
extern ExtU_M1Pos_fullHpK0_T M1Pos_fullHpK0_U;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_M1Pos_fullHpK0_T M1Pos_fullHpK0_Y;

/* Constant parameters (default storage) */
extern const ConstP_M1Pos_fullHpK0_T M1Pos_fullHpK0_ConstP;

/* Model entry point functions */
extern void M1Pos_fullHpK0_initialize(void);
extern void M1Pos_fullHpK0_step(void);
extern void M1Pos_fullHpK0_terminate(void);

/* Real-time Model object */
extern RT_MODEL_M1Pos_fullHpK0_T *const M1Pos_fullHpK0_M;
 ...
 *
 * hilite_system('M1Pos_fullHpK/M1Pos_fullHpK')    - opens subsystem M1Pos_fullHpK/M1Pos_fullHpK
 * hilite_system('M1Pos_fullHpK/M1Pos_fullHpK/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'M1Pos_fullHpK'
 * '<S1>'   : 'M1Pos_fullHpK/M1Pos_fullHpK'
 */
#endif                                 /* RTW_HEADER_M1Pos_fullHpK0_h_ */
